	...
	<form role="form" id="batch-search">  
           <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="radio">
				Mutations (hg19):&nbsp;&nbsp;
				<label><input type="radio" id="search-type" name="search-type" value="avinput">Variants &nbsp;&nbsp;</label><a href="javascript:void(0);" name="avinput" class="examples">example</a><input name="chr7 140453136 140453136 A T;;chr7 140453136 140453136 A C;;chr17 7577121 7577121 G A;;chr17 7577121 7577121 G T;;chr17 48745063 48745063 C T" type="hidden"/>&nbsp;&nbsp;
				<label><input type="radio" id="search-type" name="search-type" value="dbSNP">dbSNP IDs&nbsp;&nbsp;</label><a href="javascript:void(0);" name="dbSNP" class="examples">example</a><input name="rs121913500;;rs113488022;;rs121913343;;rs759765382;;rs1003354" type="hidden"/>&nbsp;&nbsp;
				<label><input type="radio" id="search-type" name="search-type" value="region">Genomic region&nbsp;&nbsp;</label><a href="javascript:void(0);" name="region" class="examples">example</a><input name="chr7-74146960-74147570;;chr12-25398245-25398585;;chr3-178952055-178952285" type="hidden"/>&nbsp;&nbsp;<br>
				</div>
            </div>
            <div class="form-group">
