	...
	<form role="form" id="batch-search">  
           <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div>
					<label><input type="radio" id="search-type" name="search-type" value="Summary" checked="checked" hidden = "true"></label>
					<b>Cancer summary </b>
					<br><br>
					<button id="search-btn" type="submit" class="btn btn-primary">Display</button> <br><br>
				</div>
            </div>
        </form>
        <br><br>
