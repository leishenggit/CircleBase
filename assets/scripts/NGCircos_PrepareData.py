...
if __name__=="__main__":
	if len(sys.argv)==1:
		...
		datatype=sys.argv[1]
		dataname=os.path.basename(sys.argv[2])
		# Prepare data for SCATTER demo (gallery04_SCATTER01.js).
		if datatype=="SCATTER":
			SCATTERRadius=sys.argv[3]
			print("var "+dataname.split(".")[0]+" = [ \"SCATTER_"+dataname.split(".")[0]+"\" , {")
			print("  SCATTERRadius: %s," % SCATTERRadius)
		...
		if datatype=="SNP":
			innerRadius = sys.argv[3]
			outerRadius = sys.argv[4]
			color = sys.argv[5]
			print( "var "+dataname.split(".")[0]+" = [ \"SNP_"+dataname.split(".")[0]+"\" , {")
			print( "  maxRadius: %s," % innerRadius)
			print( "  minRadius: %s," % outerRadius)
			...
			for line in fh:
				...
				if line[0]!="#":#Title line started with "#"
					line=line.split("\t")
					#print( "  {chr: \""+line[0]+"\", pos: \""+line[1]+"\", value: \""+line[2]+"\", des: \""+line[3]+"\", color: \""+color+"\", html: \""+line[3]+"\"},")
					print( "{chr: '%s', pos: '%s', value: '%s', des: '%s', color: '%s', html: '%s' }," % (line[0], line[1], line[2], line[3], color, "source: "+ line[3] +"<br>relative coordinate: "+line[0]+": "+line[1]))
			print( "]];")
		...
		if datatype=="ARC":
			innerRadius = sys.argv[3]
			outerRadius = sys.argv[4]
			print( "var "+dataname.split(".")[0]+" = [ \"ARC_"+dataname.split(".")[0]+"\" , {")
			print( "  innerRadius: %s," % innerRadius)
			print( "  outerRadius: %s," % outerRadius)
			print( "} , [")
			...
			for line in fh:
				...
				if line[0]!="#":#Title line started with "#"
					...
					print( "{chr: '%s', start: '%s', end: '%s', color: '%s', des: '%s', html: '%s' }," % (line[0], line[1], line[2], line[3], line[4], line[4]))
			print( "]];")

		# Prepare data for HEATMAP demo (gallery07_HEATMAP01.js).
		if datatype=="HEATMAP":
			print( "var "+dataname.split(".")[0]+" = [ \"HEATMAP_"+dataname.split(".")[0]+"\" , {")
		...
		if datatype=="BUBBLE":
			print( "var "+dataname.split(".")[0]+" = [ \"BUBBLE_"+dataname.split(".")[0]+"\" , {")
			print( "  minRadius: 120,")
			print( "  maxRadius: 180,")
		...
		if datatype=="LINE":
			print( "var "+dataname.split(".")[0]+" = [ \"LINE_"+dataname.split(".")[0]+"\" , {")
			print( "  maxRadius: 220,")
			print( "  minRadius: 170,")
		...
		if datatype=="HISTOGRAM":
			print( "var "+dataname.split(".")[0]+" = [ \"HISTOGRAM_"+dataname.split(".")[0]+"\" , {")
			print( "  maxRadius: 240,")
			print( "  minRadius: 205,")
		...
		if datatype=="LINK":
			fillColor = sys.argv[3]
			LinkRadius = sys.argv[4]
			print( "var "+dataname.split(".")[0]+" = [ \"LINK_"+dataname.split(".")[0]+"\" , {")
			print( "  LinkRadius: '%s'," % LinkRadius)
			print( "  LinkFillColor: \"%s\"," % fillColor)
			print( "  LinkWidth: 1,")
			print( "  LinkType:\"Q\",")
			...
			for line in fh:
				...
				if line[0]!="#": #Title line started with "#"
					...
					print( "{fusion: '%s', g1chr: '%s', g1start: '%s', g1end: '%s', g1name: '%s', g2chr: '%s', g2start: '%s', g2end: '%s', g2name: '%s', html: '%s' }," % (line[0], line[1], line[2], line[3], line[4], line[5], line[6],line[7], line[8], line[0]))
			print( "]];")

		# Prepare data for CNV demo (Figure_CNV_CNV.js).
		if datatype=="CNV":
			print( "var "+dataname.split(".")[0]+" = [ \"CNV_"+dataname.split(".")[0]+"\" , {")
			print( "  maxRadius: 155,")
			print( "  minRadius: 116,")
			print( "  CNVwidth: 2,")
		...
		if datatype=="WIG":
			print( "var "+dataname.split(".")[0]+" = [ \"WIG_"+dataname.split(".")[0]+"\" , {")
			print( "  maxRadius: 220,")
			print( "  minRadius: 170,")
		...
		if datatype=="LOLLIPOP":
			print( "var "+dataname.split(".")[0]+" = [ \"LOLLIPOP_"+dataname.split(".")[0]+"\" , {")
		...
		if datatype=="GENE":
			print( "var "+dataname.split(".")[0]+" = [ \"GENE_"+dataname.split(".")[0]+"\" , {")
		...
		if datatype=="CHORD":
			print( "var "+dataname.split(".")[0]+" = [ \"CHORD_"+dataname.split(".")[0]+"\" , {")
...
#				print(line
		...
		if datatype=="COMBINATION_SNP":
			print( "var "+dataname.split(".")[0]+" = [ \"COMBINATION_SNP_"+dataname.split(".")[0]+"\" , {")
			print( "  maxRadius: 205,")
			print( "  minRadius: 153,")
			print( "  SNPFillColor: \"#9400D3\",")
			print( "  PointType: \"circle\",")
